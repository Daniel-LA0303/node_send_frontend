...
const DropZone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta('No se pudo subir, el limite es de 1MB');
    }
                        ...
                        />
                        {
                            isDragActive ? <p className='text-2xl text-center text-gray-700'>Suelta el archivo</p> : (
                                <div className='text-center'>
                                    <p className='text-2xl text-center text-gary-600'>Selecciona un archivo y arrastralo aquí</p>
                                    <button
                                        className='bg-blue-700 w-full py-3 rounded-lg text-white my-10 hover:bg-blue-800'
                                        type='button'
                                    >Seleciona Archivos para subir</button>
                                </div>
                            )
                        }
